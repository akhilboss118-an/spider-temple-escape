...
$logPath = "C:\Users\akhil\OneDrive\Desktop\Spider-temple-Escape\Logs\build_windows.log"

$cmdArgs = @(
    "-batchmode",
    "-quit",
    "-projectPath", $projectPath,
    "-executeMethod", "Runner.EditorTools.WindowsBuildHelper.BuildWindowsStandaloneFromCommandLine",
    "-logFile", $logPath
)

Write-Host "Starting Unity Windows Standalone Build..."
