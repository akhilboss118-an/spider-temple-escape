...
$logPath = "C:\Users\akhil\OneDrive\Desktop\Spider-temple-Escape\Logs\upgrade_and_snapshot.log"

$cmdArgs = @(
    "-batchmode",
    "-quit",
    "-projectPath", $projectPath,
    "-executeMethod", "Runner.EditorTools.MenuVerificationTest.RunFullUpgradeAndSnapshotCapture",
    "-logFile", $logPath
)

Write-Host "Starting Unity Upgrade & Snapshot..."
