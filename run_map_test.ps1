...
$logPath = "C:\Users\akhil\OneDrive\Desktop\Spider-temple-Escape\Logs\map_test.log"

$cmdArgs = @(
    "-batchmode",
    "-quit",
    "-projectPath", $projectPath,
    "-executeMethod", "Runner.EditorTools.MapVerificationTest.RunBatchmodeVerification",
    "-logFile", $logPath
)

Write-Host "Starting Unity Multi-Map Verification..."
